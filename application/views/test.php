				...
				<div class="gtco-container">
					...
					<div class="row">
						...
						<div class="col-xs-8 text-right menu-1">
							<ul>
								<li><a href="index.html#destination-link">Destination</a></li>
					...
					<div class="row" style="margin-top: 10%;">
						...
						<div class="panel panel-primary filterable">
							<div class="panel-heading">
								<h3 class="panel-title">Ticket Result</h3>
								<div class="pull-right">
									<button class="btn btn-default btn-xs btn-filter"><span class="glyphicon glyphicon-filter"></span> Filter</button>
									<a href="index.html" class="btn btn-info"><span>not satisfied?</span></a>
								</div>
							</div>
							<table class="table">
								<thead>
									<tr class="filters">
										...
										<th>
											<input type="text" class="form-control" placeholder="Airline" disabled>
										</th>
										<th>
											<input type="text" class="form-control" placeholder="Departure" disabled>
										</th>
										<th>
								...
								<tbody>
									<tr>
										...
										<td>Jakarta</td>
										<td>Bali</td>
										<td>02 February 2018</td>
										<td>-1</td>
										<td><button class="btn btn-primary"><span class="glyphicon glyphicon-filter"></span> Book</button></td>
									</tr>
									<tr>
										<td>A-001</td>
										<td>Citilink</td>
